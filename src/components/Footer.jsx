    ...
    <footer className='bg-gray-800 text-white py-8 px-4 md:px-16 lg:px-24'>
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
        <div>
          ...
          <p className='mt-4'>Thank you for choosing E-Shop! We offer quality products at great prices and are always here to help. Enjoy your shopping experience!</p>
        </div>
        <div div className='flex flex-col md:items-center'>
